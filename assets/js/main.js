...
(function ($) {
  ...
  // Filmlerin detay sayfasındaki slider
  $(".movie-slider").slick({
    infinite: true,
    arrows: true,
    dots: true,
    ...
    var Slider = (function () {
      var initSlider = function () {
        ...
        swipeHandler.on("swipeleft", function (e) {
          if (dir == "rtl") $(".tp-3d-slide-arrow-left").trigger("click");
          else $(".tp-3d-slide-arrow-right").trigger("click");
        });

        swipeHandler.on("swiperight", function (e) {
          if (dir == "rtl") $(".tp-3d-slide-arrow-right").trigger("click");
        ...
        $(".tp-3d-slide-arrow-right , .tp-3d-slide-arrow-left").click(function (event) {
          ...
          if ($(this).hasClass("tp-3d-slide-arrow-left")) nextActiveSlide = $(".tp-3d-slide.active").prev();
  ...
  if ($(".tp-hero-3__title span").length > 0) {
    gsap.set(".tp-hero-3__title span", { scale: 0.5, opacity: 0 });
